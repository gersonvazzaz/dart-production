...
items:
  ...
  - title: Kappa Box - Robe di Kappa collection
    ...
    clientText: >
      ...
      collezione, creando un packaging capace di rafforzarne identità,
      storytelling e presentazione.
    workText: Abbiamo progettato e prodotto box customizzate studiate attorno alla
      collezione, sviluppando grafica, materiali e dettagli in linea con
      l’estetica del brand e del drop.
    galleryItems:
      - title: Foto 1
      - title: Foto 2
      - title: Foto 3
  - title: Rositano Macelleria - Personalizzazione del banco vendita
    category: Allestimento
    imagePlaceholder: Foto progetto 3
    clientText: La macelleria Rositano voleva valorizzare il banco vendita del
      mercato attraverso una personalizzazione visiva capace di rendere lo
      spazio più riconoscibile e coerente con l’identità dell’attività.
    workText: Abbiamo sviluppato un intervento di personalizzazione per il banco
      macelleria, progettando elementi grafici e applicazioni visive pensate per
      migliorare l’impatto estetico e la presenza del brand all’interno del
      mercato.
    galleryItems:
      - title: Foto 1
      - title: Foto 2
      - title: Foto 3
  - title: MAD - Stampa Collezioni
    category: Stampa
    imagePlaceholder: Foto progetto 4
    clientText: Il brand MAD aveva la necessità di produrre le stampe per i diversi
      drop di collezione, mantenendo coerenza qualitativa e valorizzando ogni
      capo attraverso tecniche adatte ai diversi materiali e design.
    workText: Ci siamo occupati della stampa delle collezioni del brand,
      selezionando e applicando diverse tecniche di stampa in base agli item
      proposti, per garantire resa estetica, qualità e coerenza con l’identità
      dei vari drop.
    galleryItems:
      - title: Foto 1
      - title: Foto 2
  ...
  - title: Fresh Cut - Merchandising e Gadget
    ...
    clientText: Fresh Cut aveva la necessità di sviluppare merchandising coordinato,
      includendo divise, stampe e gadget personalizzati in 3D per rafforzare
      l’identità del brand.
    workText: Ci siamo occupati della produzione di divise, stampe e gadget
      personalizzati anche in 3D, sviluppando oggetti su misura coerenti con
  ...
  - title: "React - Merchandising "
    ...
    clientText: >-
      REACT, collettivo e serata/evento con DJ set, aveva la necessità di
      sviluppare un merchandising dedicato capace di rappresentarne identità,
      immaginario visivo e atmosfera dell’evento.

      Cosa abbiamo fatto
    workText: "Abbiamo progettato e prodotto merchandising personalizzato,
      sviluppando una grafica coerente con l’obiettivo di rafforzare l’identità
  ...
  - title: Urbani pasticceria - Stampa e Ricamo
    ...
    clientText: In vista della nuova apertura, il cliente necessitava di una
      fornitura completa di merchandising e divise coordinate per lo staff, con
      personalizzazioni realizzate tramite diverse tecniche di stampa.
    workText: Abbiamo curato l’intero processo di produzione, occupandoci della
      progettazione dei materiali grafici, della selezione dei supporti e delle
      tecniche di personalizzazione più adatte (stampa e finiture), fino alla
      realizzazione finale di tutto il merchandising e delle divise, garantendo
  ...
  - title: "SKASSAPANZA - Murales "
    ...
    clientText: Il cliente aveva la necessità di realizzare un murales decorativo
      per il locale di Chivasso, in grado di rafforzare l’identità del brand e
      caratterizzare lo spazio interno
    workText: Ci siamo occupati dell’intero progetto, ideando e sviluppando un
      murales su misura, coerente con l’immagine del marchio e con lo stile del
  ...
  - title: Kappa - Box Custom 433
    ...
    clientText: Il cliente aveva la necessità di realizzare delle box personalizzate
      per il brand 433, noto media internazionale a tema calcio su Instagram.
    workText: Abbiamo sviluppato il concept grafico e seguito la produzione delle
      box custom, curando ogni dettaglio estetico e funzionale per garantire un
      risultato in linea con lo stile comunicativo e l’identità visiva del brand
      433.
    galleryItems:
      - title: Foto 1
      - title: Foto 2
